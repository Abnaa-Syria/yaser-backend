...
import studentMyFlashcardRoutes from '../modules/student/flashcards/student-my-flashcard.routes.js';
...
apiRouter.use('/student/my-flashcards', studentMyFlashcardRoutes);
