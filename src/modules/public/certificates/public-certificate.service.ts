...
import {
  certificateLinkMeta,
  getCertificatePdfBufferBySerial,
} from '../../shared/certificate-pdf.service.js';
import { APP_BRAND } from '../../../config/brand.config.js';

export const verifyCertificate = async (serialNumber: string) => {
...
export const downloadCertificateBySerial = async (serialNumber: string) => {
