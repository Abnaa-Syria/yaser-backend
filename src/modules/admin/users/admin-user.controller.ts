...
export const toggleActive = catchAsync(async (req: Request, res: Response) => {
  const result = await adminUserService.toggleUserActive(req.params.id as string, req.user.id);
  successResponse({
    res,
    data: result,
...
export const setUserPassword = catchAsync(async (req: Request, res: Response) => {
  const result = await adminUserService.setUserPasswordByAdmin(
...
export const deleteUser = catchAsync(async (req: Request, res: Response) => {
  const result = await adminUserService.deleteUser(req.params.id as string, req.user.id);
...
export const grantPermission = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await adminUserService.grantUserPermission(
    req.params.id as string,
...
export const revokePermission = catchAsync(async (req: Request, res: Response) => {
  const result = await adminUserService.revokeUserPermission(
    req.params.id as string,
...
export const getUserSessions = catchAsync(async (req: Request, res: Response) => {
  const result = await adminUserService.getUserSessions(req.params.id as string);
  successResponse({ res, data: result });
});

export const getUserDevices = catchAsync(async (req: Request, res: Response) => {
  const result = await adminUserService.getUserDevices(req.params.id as string);
  successResponse({ res, data: result });
});

export const forceLogout = catchAsync(async (req: Request, res: Response) => {
  const result = await adminUserService.forceLogoutUser(req.params.id as string, req.user.id);
