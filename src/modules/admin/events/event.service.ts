...
export const getAllEventsForAdmin = async (query: { page?: string; limit?: string }) => {
...
export const updateEvent = async (id: string, data: UpdateEventInput) => {
  ...
  if (data.bannerUrl !== undefined) updateData.bannerUrl = data.bannerUrl ? data.bannerUrl.trim() : null;
...
export const getPublicActiveEventById = async (id: string) => {
