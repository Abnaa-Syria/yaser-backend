...
export const getSubscriptions = catchAsync(async (_req: Request, res: Response) => {
  const data = await subscriptionService.getAllSubscriptions();
  successResponse({ res, data });
});

export const updateSubscriptionStatus = catchAsync(async (req: Request, res: Response) => {
  const data = await subscriptionService.updateSubscriptionStatus(req.params.id as string, req.body.status);
...
export const getEnrollments = catchAsync(async (_req: Request, res: Response) => {
...
export const getLookupData = catchAsync(async (_req: Request, res: Response) => {
