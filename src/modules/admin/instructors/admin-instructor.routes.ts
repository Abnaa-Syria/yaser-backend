...
router.post(
  '/:id/availability',
  validate(adminValidation.createAvailabilitySchema),
  adminController.createInstructorAvailability
);
router.patch(
  '/:id/availability/:slotId',
  validate(adminValidation.updateAvailabilityPriceSchema),
  adminController.updateInstructorAvailabilityPrice
);
router.delete(
  '/:id/availability/:slotId',
  validate(adminValidation.availabilitySlotParamSchema),
  adminController.deleteInstructorAvailability
);
