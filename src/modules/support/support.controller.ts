...
export const createTicketAsAdmin = catchAsync(async (req: Request, res: Response) => {
...
export const replyToTicket = catchAsync(async (req: Request, res: Response) => {
  const data = await supportService.replyToTicket(req.user.id, req.params.id as string, req.body.message);
...
export const adminReplyToTicket = catchAsync(async (req: Request, res: Response) => {
...
export const processTicket = catchAsync(async (req: Request, res: Response) => {
  const { status, response } = req.body;
  const data = await supportService.processTicket(req.params.id as string, req.user.id, status, response);
...
export const getTicket = catchAsync(async (req: Request, res: Response) => {
  const data = await supportService.getTicketById(req.params.id as string);
