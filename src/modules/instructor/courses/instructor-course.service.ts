 ...
 */
export const assertInstructorOwnsCourse = async (courseId: string, instructorId: string) => {
 ...
 */
export const getInstructorCourses = async (instructorId: string, options: any) => {
  const page = Number(options.page) || 1;
  const limit = Number(options.limit) || 10;
  const skip = (page - 1) * limit;
  const { categoryId, status, search } = options;

  const where: any = notDeleted({ instructorId });
 ...
 */
export const getInstructorCourseById = async (courseId: string, instructorId: string) => {
  const course = await prisma.course.findFirst({
    where: notDeleted({ id: courseId, instructorId }),
    include: {
      category: true,
 ...
 */
export const createInstructorCourse = async (instructorId: string, data: any) => {
 ...
 */
export const updateInstructorCourse = async (courseId: string, instructorId: string, data: any) => {
 ...
 */
export const deleteInstructorCourse = async (courseId: string, instructorId: string) => {
  await assertInstructorOwnsCourse(courseId, instructorId);
 ...
 */
export const submitCourseForReview = async (courseId: string, instructorId: string) => {
  await assertInstructorOwnsCourse(courseId, instructorId);
