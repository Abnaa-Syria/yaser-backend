...
export const getOrCreateWallet = async (instructorId: string) => {
...
export const getTransactions = async (instructorId: string, pageRaw?: number | string, limitRaw?: number | string) => {
...
export const getPayoutRequests = async (instructorId: string) => {
...
export const createPayoutRequest = async (
  instructorId: string,
  data: { amount: number; payoutMethod: string; payoutDetails: string }
) => {
