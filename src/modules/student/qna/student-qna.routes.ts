...
router.get(
  '/questions',
  qnaController.getMyQuestions
);

router.get(
  '/lessons/:lessonId/questions',
  validate(qnaValidation.lessonIdParamSchema),
  qnaController.getLessonQuestions
);

router.post(
  '/lessons/:lessonId/questions',
  validate(qnaValidation.createQuestionSchema),
  qnaController.createQuestion
);

router.post(
  '/questions/:questionId/answers',
  validate(qnaValidation.createAnswerSchema),
