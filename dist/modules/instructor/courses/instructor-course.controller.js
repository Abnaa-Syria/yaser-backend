...
export const getCourseById = catchAsync(async (req, res) => {
    const result = await instructorCourseService.getInstructorCourseById(req.params.id, req.user.id);
    successResponse({
        res,
        data: result,
...
export const updateCourse = catchAsync(async (req, res) => {
    const result = await instructorCourseService.updateInstructorCourse(req.params.id, req.user.id, req.body);
    successResponse({
        res,
        data: result,
...
export const deleteCourse = catchAsync(async (req, res) => {
    const result = await instructorCourseService.deleteInstructorCourse(req.params.id, req.user.id);
    successResponse({
        res,
        data: result,
...
export const submitForReview = catchAsync(async (req, res) => {
    const result = await instructorCourseService.submitCourseForReview(req.params.id, req.user.id);
    successResponse({
        res,
        data: result,
