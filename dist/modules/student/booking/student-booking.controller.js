...
export const listAvailableSlotsHandler = catchAsync(async (req, res) => {
...
export const bookSessionHandler = catchAsync(async (req, res) => {
    const { paymentMethod, receiptUrl } = req.body;
    const result = await bookingService.bookPrivateSession(req.user.id, String(req.params.availabilityId), { paymentMethod, receiptUrl });
    successResponse({
        res,
        data: result,
...
//# sourceMappingURL=student-booking.controller.js.map