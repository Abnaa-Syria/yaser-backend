...
async function shapeExamDetailsForStudent(exam, mySubmission) {
 ...
 */
export const getAvailableExams = async (studentId, filters = {}) => {
 ...
 */
export const getExamDetails = async (studentId, examId) => {
 ...
 */
export const startExam = async (studentId, examId) => {
    const exam = await prisma.exam.findUnique({
        where: { id: examId },
        include: {
...
export const submitExam = async (studentId, examId, answers) => {
 ...
 */
export const getSubmissionResult = async (studentId, submissionId) => {
