...
export const listPrivateSessionRequests = async (query) => {
...
export const updatePrivateSessionRequest = async (id, data) => {
...
//# sourceMappingURL=admin-private-session-request.service.js.map