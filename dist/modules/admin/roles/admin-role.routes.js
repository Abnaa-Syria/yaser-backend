...
router.put('/:id/permissions', requirePermission('role:manage'), validate(roleValidation.setPermissionsSchema), roleController.setRolePermissions);
router.delete('/:id', requirePermission('role:manage'), roleController.deleteRole);
export default router;
//# sourceMappingURL=admin-role.routes.js.map