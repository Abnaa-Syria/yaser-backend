...
export const toggleReview = catchAsync(async (req, res) => {
    const data = await cmsService.toggleReviewVisibility(req.params.id);
    successResponse({ res, data, message: 'Review visibility toggled successfully' });
});
export const togglePackage = catchAsync(async (req, res) => {
    const data = await cmsService.togglePackageVisibility(req.params.id);
...
export const upsertSectionByKey = catchAsync(async (req, res) => {
    const key = String(req.params.key || '').trim().toUpperCase();
    if (!key)
        throw new AppError('Section key is required', 400);
...
export const updateSection = catchAsync(async (req, res) => {
    const data = await cmsService.updateSectionById(req.params.id, req.body);
...
export const addFaqItem = catchAsync(async (req, res) => {
    const data = await cmsService.addFaqItem(req.body);
    successResponse({ res, data, message: 'FAQ item added successfully' });
});
export const updateFaqItem = catchAsync(async (req, res) => {
    const data = await cmsService.updateFaqItem(req.params.id, req.body);
    successResponse({ res, data, message: 'FAQ item updated successfully' });
});
export const deleteFaqItem = catchAsync(async (req, res) => {
...
export const toggleFeatureReview = catchAsync(async (req, res) => {
    const data = await cmsService.toggleFeatureReview(req.params.id, req.body.isFeatured);
...
export const updatePackageStatus = catchAsync(async (req, res) => {
    const data = await cmsService.updatePackageStatus(req.params.id, req.body);
...
export const getPosts = catchAsync(async (req, res) => {
    ...
    successResponse({ res, data, results: data.posts.length, message: 'Posts fetched successfully' });
});
...
export const updatePost = catchAsync(async (req, res) => {
    const data = await cmsService.updatePost(req.params.id, req.body);
...
// --- CMS Pages ---
export const getCmsPages = catchAsync(async (req, res) => {
    const data = await cmsService.getAllCmsPages();
    successResponse({ res, data, results: data.length });
});
export const getCmsPage = catchAsync(async (req, res) => {
    const data = await cmsService.getCmsPageBySlug(req.params.slug);
    if (!data)
        throw new AppError('Page not found', 404);
    successResponse({ res, data });
});
export const updateCmsPage = catchAsync(async (req, res) => {
    const data = await cmsService.updateCmsPageBySlug(req.params.slug, req.body);
