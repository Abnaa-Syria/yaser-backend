...
router.post('/questions/:questionId/answers', validate(qnaValidation.adminAnswerSchema), qnaController.replyToQuestion);
router.patch('/questions/:questionId/resolve', validate(qnaValidation.questionIdParamSchema), qnaController.toggleResolve);
export default router;
//# sourceMappingURL=admin-qna.routes.js.map