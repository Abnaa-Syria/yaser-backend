...
function issueTrialToken(session) {
...
function remainingPayload(session) {
...
export async function getTrialMe(trialId, fingerprint) {
...
export async function requireTrialCourseAccess(courseId) {
    const settings = await loadTrialSettings();
    if (!settings.enabled) {
        throw new AppError('Free trial is currently disabled.', 403);
    }
...
export async function getTrialCourseContent(courseId) {
...
export async function getTrialLessonPlayback(lessonId, trialId) {
