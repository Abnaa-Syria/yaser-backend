...
async function isMaintenanceStaff(req) {
...
export const maintenanceGuard = catchAsync(async (req, _res, next) => {
    ...
    return next(Object.assign(new AppError('The platform is temporarily under maintenance. Please try again later.', 503), {
        code: 'MAINTENANCE',
    }));
});
